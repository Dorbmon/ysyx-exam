...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 101 ????? 00110 11", srliw  , I, R(dest) = SEXT((uint64_t)src1 >> (uint32_t)src2, 32));
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 00110 11", sraiw  , I,  R(dest) = SEXT((int32_t)src1 >> (int32_t)(src2 & ((1 << 6) - 1)), 32));
  ...
  INSTPAT("000000? ????? ????? 101 ????? 00100 11", srli   , I,  R(dest) = SEXT((uint64_t)src1 >> (uint64_t)src2, 32));
  ...
  INSTPAT("000000? ????? ????? 001 ????? 00100 11", slli   , I,  printf("src2:%llx\n", BITS((s)->isa.inst.val, 25, 20)), R(dest) = src1 << (src2 & ((1 << 4) - 1)));
