...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("000000? ????? ????? 101 ????? 00100 11", srli   , I,  R(dest) = SEXT((uint64_t)src1 >> (uint64_t)(src2 & ((1 << 5) - 1)), 32));
  ...
  INSTPAT("000000? ????? ????? 001 ????? 00100 11", slli   , I,  printf("rrrr:%ld\n", (src2 & ((1 << 5) - 1))), R(dest) = src1 << (src2 & ((1 << 5) - 1)));
