...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 000 ????? 01000 11", sb     , S, printf("sb:%lx\n", src1 + dest), Mw(src1 + dest, 1,(uint8_t)src2 ));
  ...
  // ecall: a7寄存器中存放了调用号
  INSTPAT("0000000 00000 ????? 000 ????? 11100 11", ecall  , I,  s->dnpc = isa_raise_intr((1ull << 63), s->pc));
